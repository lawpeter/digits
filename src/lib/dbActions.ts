...
import { Contact } from './validationSchemas';
 ...
 * @param contact An object with firstName, lastName, address, image, description, and owner.
 */
 ...
 * @param note An object with note, contactId, owner.
 */
